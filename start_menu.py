                        ...
                        for button in self.buttons:
                            if button.is_clicked(pygame.mouse.get_pos()):
                                ...
                                if button.text == "CONTINUE":
                                 ...
                                 print(loaded_game_state.house, loaded_game_state.pet, loaded_game_state.name, loaded_game_state.selected_character, loaded_game_state.time_hour, loaded_game_state.time_minute, loaded_game_state.GameData)
                                 from first_page import Game
                                 loadSave = Game(loaded_game_state.house, loaded_game_state.pet,loaded_game_state.name, loaded_game_state.selected_character, loaded_game_state.time_hour, loaded_game_state.time_minute, loaded_game_state.fromPriorMenu, loaded_game_state.GameData)
                                 loadSave.run()
                                 running = False
