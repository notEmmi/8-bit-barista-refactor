...
# Initialize Pygame
    ...
    darkbg = pygame.image.load("assets/images/others/darkbg.png")
    darkbg = pygame.transform.scale(darkbg, (WIDTH, HEIGHT))

    errorsign = pygame.image.load("assets/images/others/errorsign_transparent.png")
    errorsign = pygame.transform.scale(errorsign, (250, 400))

    cloud = pygame.image.load("assets/images/others/rain_transparent.png")
